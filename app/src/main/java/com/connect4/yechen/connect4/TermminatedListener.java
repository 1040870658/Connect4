...
public class TermminatedListener implements Animator.AnimatorListener{
    ...
    private int col;
    private float Y;
    public TermminatedListener(int col, Handler handler, Board board){
        this.board = board;
    ...
    public void onAnimationEnd(Animator animation) {
        ...
        handler.sendEmptyMessage(GamePresenter.GAME_DRAW);
    }
